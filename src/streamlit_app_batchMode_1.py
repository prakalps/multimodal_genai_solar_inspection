    ...
    with tempfile.TemporaryDirectory() as tmp_dir:
        ...
        if not csv_files:
            ...
            if "image_name" not in notes_df.columns or "technical_note" not in notes_df.columns:
                ...
                # Normalize CSV image names for case-insensitive match
                ...
                for image_path in image_files:
                    try:
                        ...
                        # Match image name with CSV row
                        note_row = notes_df[notes_df["image_name_lower"] == img_name]
                        if note_row.empty:
                            st.warning(f"No technician note for {image_path}. Skipping.")
                            continue
...
"""
                        ...
                        results.append((os.path.basename(image_path), report))
